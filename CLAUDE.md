...
**Single Source of Truth:** `bedrock-config.json` contains all environment variables, valid regions, and defaults. Both Bash and PowerShell scripts read from this file (Bash prefers jq, falls back to python3/python; PowerShell uses ConvertFrom-Json).
